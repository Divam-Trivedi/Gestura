...
def generate_launch_description():
    ...
    bridge = Node(
        ...
        arguments=[
            ...
            gz_topic + '/cmd_vel2@geometry_msgs/msg/Twist@gz.msgs.Twist',
            gz_topic + '/odometry@nav_msgs/msg/Odometry@gz.msgs.Odometry',

            gz_topic + '/cmd_vel@geometry_msgs/msg/Twist@gz.msgs.Twist',

            '/model/vehicle/joint/left_gripper_joint@std_msgs/msg/Float64[gz.msgs.Double',
        ...
        remappings=[
            ...
            # (gz_topic + '/cmd_vel2', gz_topic + '/cmd_vel2'),

            # ('/model/vehicle/joints/arm1_joint/cmd', '/arm1/joint_cmd'),
            # ('/model/vehicle/joints/arm2_joint/cmd', '/arm2/joint_cmd'),
            # ('/model/vehicle/joint/left_gripper_joint', '/left_gripper_joint/cmd_pos'),

        ],
        parameters=[{'qos_overrides./tf_static.publisher.durability': 'transient_local'}, {'use_sim_time': True},],
        output='screen'
    )
